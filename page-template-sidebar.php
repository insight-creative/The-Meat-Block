...
<div id="primary" class="universal-content-area">
	<main id="home" class="site-main">
				...
				while ( have_rows('hero_block') ) : the_row();
					if( get_row_layout() == 'hero_block' ):
						...
						if( get_sub_field('hero_title') ):
							...
							echo '<h1 class="whiteText blockTitle"><span class="blackBack">' . get_sub_field('hero_title') . '</span></h1>';
							echo '</div>';
							echo '</div>';
						endif;
						echo '</div>';
						...
						while ( have_rows('content_fields') ) : the_row();
							// Vars
									...
									if( get_sub_field('button') ):
										...
										echo '<div class="paddedSection limitWidth">';
		...
		<section id="fullWidthCTA">
			<div id="ctaContent" class="pageWidth centerText limitWidth">
				<h6 class="largeHeading">Find more of what we have to offer</h6>
				<p>
